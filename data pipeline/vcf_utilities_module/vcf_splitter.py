...
args.add_argument("--vcf_file", default="/home/frederik/github_projects/SNPster/data pipeline/vcf_merge_sheets_export/vcf_merge_sheet_chr22.csv", help="Path to the CSV file containing VCF file information for merging.")
