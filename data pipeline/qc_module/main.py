...
imputed_data_container.set_chromosome_from_data()
...
print(f"Completed chromosome {imputed_data_container.chromosome} and written to {args.output_dir}. Memory freed.")
